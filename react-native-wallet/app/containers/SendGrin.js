...
import { SEND_AMOUNT, NEW_RECIPIENT } from '../constants/routeName'
...
export default class SendGrin extends React.Component {
    ...
    render() {
        return (
            <View style={ApplicationStyles.screen.safeView}>
                <Header goBack={this.goBack} title={'SEND GRIN TO'} />
                ...
                <FlatList
                    ...
                    renderItem={({ item }) =>
                        <ContactItem item={item} onPress={this.goTo(SEND_AMOUNT)} />
                    } />
            </View>
        )
    }
